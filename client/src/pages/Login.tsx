...
import { Code2, GitCommit, Cpu } from 'lucide-react'; // Novos ícones
...
export default function LoginPage() {
  ...
  // Variante para os widgets flutuantes
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#020205] text-zinc-100 relative overflow-hidden p-4">
      ...
      {/* --- WIDGETS FLUTUANTES (DECORAÇÃO) --- */}
      {/* Widget Esquerda Superior */}
      <motion.div 
      ...
      >
          ...
          <div>
              <div className="text-[10px] text-zinc-400">Status do Sistema</div>
              <div className="text-xs font-bold text-white flex items-center gap-1">
                  <span className="w-1.5 h-1.5 bg-green-500 rounded-full animate-pulse"/> Compilando...
              </div>
          </div>
      </motion.div>

      {/* Widget Direita Inferior */}
      <motion.div 
          variants={floatingWidgetVariant}
          animate="animate"
          transition={{ delay: 1 }}
      ...
      >
          ...
          <div>
              <div className="text-[10px] text-zinc-400">Último Commit</div>
              <div className="text-xs font-mono text-white">feat: login_ui_update</div>
          </div>
      </motion.div>
